...
//@Disabled
@TeleOp(name="Demo: Gamepad", group ="Demos")
public class DemoGamepadMJR extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            if (gamepad1.left_stick_button){
                ...
                telemetry.addData(">", "Press touchpad for rgbEffect");

            }

            if (gamepad1.touchpad_finger_1) {
                gamepad1.setLedColor(255, 0, 0, 255);
            } else {
                telemetry.addData(">", "Press 1 finger on touchpad for red");

            }

            if (gamepad1.touchpad_finger_2) {
                gamepad1.setLedColor(0,255,0,255);
            } else {
                telemetry.addData(">", "Press 2 fingers on touchpad for green");
            }
